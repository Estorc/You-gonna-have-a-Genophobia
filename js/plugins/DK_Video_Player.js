...
/*:
 * @plugindesc v.1.2.4 [MV|MZ] Adds video to the title screen, credits, the layers on the map and other.
 * @author DKPlugins
 ...
 *note: The change occurs after a new video is loaded and the previous video ends.
 ...
 2. Mouse System (https://dk-plugins.ru/mouse-system/)
...
/*:ru
 * @plugindesc v.1.2.4 [MV|MZ] Добавляет видео перед титульным экраном, титры, слои на карте и другое.
 * @author DKPlugins
 * @url https://dk-plugins.ru
 * @target MZ
 * @orderAfter DK_Game_Time
 ...
 *заметка: Изменение происходит после загрузки нового видео и окончания предыдущего видео.
 ...
 2. Система Мыши (https://dk-plugins.ru/mouse-system/)
...
Imported['DK_Video_Player'] = '1.2.4';
...
Spriteset_Map.prototype.placeVideoPlayerBeforePictures = function() {
    this.addChildAt(this._videoPlayer, 1);
};
